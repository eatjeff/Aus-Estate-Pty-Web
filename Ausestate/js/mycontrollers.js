...
angular.module('ausestateApp')
        ...
        .controller('SearchController', ['$scope','propertyFactory',function($scope,propertyFactory) {
            ...
            {
                $scope.navproperties = propertyFactory.getAllPropertiesByAreacode().query($scope.areacode,
                function(response){
        ...
        .controller('PropertyDetailController', ['$scope','$stateParams','propertyFactory',function($scope,$stateParams,propertyFactory) {
            ...
            $scope.purchasetype = [{value:"buy", label:"BUY"}, {value:"rent",label:"RENT"},{value:"share", label:"SHARE"}];
            ...
            $scope.propertystatus = [{value:"for sale", label:"FOR SALE"}, {value:"suspend",label:"SUSPEND"},{value:"sold",label:"SOLD"}];
