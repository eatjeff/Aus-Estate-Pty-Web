...
.post(function (req, res, next) {
    ...
    var commentorChannel = req.body.mychannel;
    ...
    to: '"ausestate" <info@austestate.com.au>', // list of receivers
    subject: 'Enquiry about property', // Subject line
    text: 'Hello world\n'+
